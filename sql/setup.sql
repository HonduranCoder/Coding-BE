...
CREATE TABLE users (
  ...
  bio TEXT, 
  member_since TEXT, 
  created TIMESTAMP WITH TIME XZONE DEFAULT CURRENT_TIMESTAMP
); 

INSERT INTO user (github, email, avatar, repos, bio, member_since)
VALUES ('fakename', 'fakememail@gmail.com', 'https://avatars.githubusercontent.com/u/79884362?v=4', 75, 'bio', '2021-03-02T01:35:50Z');

CREATE TABLE posts (
  post_id BIGINT GENERATED AS ALWAYS AS IDENTITY PRIMARY KEY, 
...
CREATE TABLE comments (
  comment_id BIGINT GENERATED AS ALWAYS AS IDENTITY PRIMARY KEY, 
